            ...
            <div className='pl-5 w-[80%]'>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div className='flex space-x-2 items-center'>
                        <div className='text-xs py-1 px-2 text-white bg-green-500  rounded-full'>5</div>
                    </div>
                </div>
            </div>
        </div>
